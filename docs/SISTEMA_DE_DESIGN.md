...
O portal replica a linguagem funcional do AVA oficial apenas no fluxo de disciplinas e aulas. A base visual é clara, compacta e orientada por navegação: azul-marinho, marfim, cobre e superfícies off-white, com bordas discretas e cartões com raio moderado. Inter é usada nos títulos, subtítulos, controles e elementos de navegação; Nunito é usada na leitura de conteúdo; os ícones são locais do Font Awesome.
